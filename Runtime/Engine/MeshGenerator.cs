...
internal class MeshGenerator : ScriptableObject
{
	...
	public Mesh GenerateUnitQuadMesh()
	{ // basis for a plane
	...
	public Mesh SubdivideCPU(Mesh mesh, int depth = 1)
	{
		if (depth <= 0)
		{
	...
	public Mesh SubdivideGPU(Mesh mesh, int depth = 1)
	{
	...
	public Mesh NormalizeAndAmplify(Mesh mesh, float gain)
	{
		Vector3[] vertices = mesh.vertices;
		...
		meshShader.SetBuffer(kernelIndex, "vertice_array", vertexBuffer);
		meshShader.Dispatch(kernelIndex, vertices.Length / 16, 1, 1);
